  ...
  func test_fetchMultiplePages() async throws {
    ...
    try XCTAssertSuccessResult(result) { output in
      ...
      print("""
        ...
        data.hero.friendsConnection equal.__data._fulfilledFragments: \(first?.data?.hero.friendsConnection.__data._fulfilledFragments == last?.data?.hero.friendsConnection.__data._fulfilledFragments)
