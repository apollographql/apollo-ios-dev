...
public extension MyAPI {
  struct PetDetailsMutation: MyAPI.MutableSelectionSet, Fragment {
    ...
    ///
    /// Parent Type: `Human`
    public struct Owner: MyAPI.MutableSelectionSet {
      public var __data: DataDict
      public init(_dataDict: DataDict) { __data = _dataDict }

      public static var __parentType: any ApolloAPI.ParentType { MyAPI.Objects.Human }
      public static var __selections: [ApolloAPI.Selection] { [
        .field("__typename", String.self),
      ...
      public init(
        ...
        self.init(_dataDict: DataDict(
          data: [
            "__typename": MyAPI.Objects.Human.typename,
            "firstName": firstName,
          ],
          fulfilledFragments: [
