...
> This article explains how you can access cache data directly. To learn how you can use the cache alongside network requests to fetch data for your GraphQL operations, read our documentation on [fetching locally cached queries](./../fetching/queries#fetching-locally-cached-queries).
