...
> For more information on executing each operation type, see the documentation on [Queries](./queries), [Mutations](./mutations), and [Subscriptions](./subscriptions).
