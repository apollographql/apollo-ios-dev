...
If you need to use Apoll iOS and the code generation output as an XCFramework, this page will give a high level overview of how to do so, as well as collect some tips on things you may encounter that have been reported by the community.
...
You can also use the output from code generation as an XCFramework, you will need to configure this setup yourself, however you can use of [code generation test](https://github.com/apollographql/apollo-ios-dev/tree/main/Tests/TestCodeGenConfigurations/CodegenXCFramework) of this as an example/starting point.
