...
Apollo iOS supports executing GraphQL operations over [WebSocket](https://developer.mozilla.org/en-US/docs/Web/API/WebSocket) using the [`graphql-transport-ws`](https://github.com/enisdenjo/graphql-ws/blob/master/PROTOCOL.md) protocol. This is the recommended approach for GraphQL subscriptions and is provided by `ApolloWebSocket`.
