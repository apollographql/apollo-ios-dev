...
public class AnyGraphQLQueryPager<Model> {
  ...
  public init<Pager: GraphQLQueryPagerWrapper<InitialQuery, NextQuery>, InitialQuery, NextQuery>(
    pager: Pager,
  ...
  public convenience init<
    Pager: GraphQLQueryPagerWrapper<InitialQuery, NextQuery>,
    InitialQuery,
    NextQuery,
    Element
  >(
...
public extension GraphQLQueryPager {
  func eraseToAnyPager<T>(
    ...
    AnyGraphQLQueryPager(
      pager: GraphQLQueryPagerWrapper(pager: self),
      transform: transform
    )
  }
...
public extension GraphQLQueryPagerWrapper {
  func eraseToAnyPager<T>(
    transform: @escaping (InitialQuery.Data, [PaginatedQuery.Data]) throws -> T
  ) -> AnyGraphQLQueryPager<T> {
